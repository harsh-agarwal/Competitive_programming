...
bool solve(const string &S, int j, unordered_multiset<string> L)
{
...
int main() {
	...
	vector<string> str(words, words + sizeof words / sizeof words[0]);

	vector<int> v = solve("barfoothefoobarman", str);
